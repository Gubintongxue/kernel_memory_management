...
![image](image/2de42ba2f16b859dd74a52cede7bc4f0.png)
...
![image](image/0e8203feb98dc301cdc5fa408319d49b.png)
...
![image](image/e526f6c1ab5271d99a7097b347567def.png)
...
![image](image/fcaa0928ee2393d24a7aa607904b9162.png)
...
![image](image/7a49751f33bb7a574817413b9d16b7f7.png)
...
![image](image/706ea8488fd1b5148d48952c95c4cf71.png)
...
![image](image/c15e60b4fc1518cf2fcda631965d0640.png)

而每个存储器模块中包含了 8 个 DRAM 芯片，编号从 0 - 7 。

![image](image/4dd4669e06dff865b24117ca5e483453.png)
...
![image](image/ecfc1e6f515b2e81edfa682a9f33eef2.png)
...
![image](image/798cd191ab13798e8b9ab9208658f7b1.png)

由于存储器模块中这种由 8 个 DRAM 芯片组成的物理存储结构的限制，内存读取数据只能是按照物理内存地址，8 个字节 8 个字节地顺序读取数据。所以说内存一次读取和写入的单位是 8 个字节。

![image](image/d59042d15cd56af53054abb0422cd06c.png)
...
[一步一图带你深入理解 Linux 虚拟内存管理-CSDN博客](https://blog.csdn.net/weixin_47282449/article/details/127511371)