...
![image](image/b53f3c835c0f70e4155a61615d0a11a9.png)
...
![image](image/661846dd9583daac4b2d9504825f7b12.png)
...
![image](image/db46078ede64baaa19e658e0ffdc651f.png)
...
![image](image/6020bb90d8463bc3481db6339a56aea2.png)
...
![image](image/0fe0a576a4bfa859a9865833faba344b.png)
...
![image](image/acb5684a32ba219c33247f49d87156c5.png)
...
然后==在这些可能会被拔出的内存中只分配那些可迁移的内存页，这些信息会在内存初始化的时候被设置，这样一来那些不可迁移的页就不会包含在可能会拔出的内存中，当我们需要将这块内存热拔出时, 因为里边的内存页全部是可迁移的, 从而使内存可以被拔除==。
...
![image](image/6373a4c759c20f27edb489c56947c540.png)
...
> 除了 numactl 这个工具外，我们还可以通过共享库 libnuma 在程序中进行 NUMA 相关的操作。这里笔者就不演示了，感兴趣可以查看下 libnuma 的 API 文档：https://man7.org/linux/man-pages/man3/numa.3.html#top\_of\_page
...
![image](image/65ea4257e39669e6f87aba15b332d45f.png)
...
![image](image/d5b8a03e017247e393344cf5d6835a0c.png)
...
![image](image/2e4f1597aee0596789db5db73e959465.png)
...
![image](image/8b1cfd2bdb84f1720d7e0e1599e0d324.png)
...
![image](image/918cf8aa4c4f84596126a3c3f73be0f9.png)
...
![image](image/16449948e9605c0814c296f930ff7c60.png)
...
![image](image/77ae5d696528628ce198f9fe224ab567.png)
...
![image](image/68b07e9336440d2a26c72a9df55deac1.png)
...
![image](image/20f30ff625ada1887e63f51735862605.png)
...
![image](image/9a6ee8140b5f78a0d1e25cbe4319d621.png)
...
![image](image/c264982f672681d99ab557af183e1957.png)
...
![image](image/a78823190e883fe66488b364a4fba221.png)
...
![image](image/e4f660e57193a09c2b4a2b378d546408.png)
...
![image](image/ec280af79fc2729299b280ae024dd31f.png)
...
![image](image/e712c320c757ab70141c283ef336d2d0.png)
...
![image](image/49170ae592d8190f1ca8bc0193a2d8ee.png)
...
![image](image/2babd25928e5f8633efa6817bd9b6560.png)
...
![image](image/f736fcbdced7e7502e4c69d9e62f2a04.png)
...
![image](image/878f33d825ea523c38f8780258c4a8c8.png)
...
![image](image/f18cc7d5f15e96e648fedad343753cc1.png)
...
![image](image/9a428d776ad4ef32ecee434f9e91352b.png)
...
![image](image/28ccb53ed837a3db4aa6aeeef82df7b6.png)
...
![image](image/acab1854babee322025f27a12c02be9a.png)
...
![image](image/86da8b9f064bb996dd61391a60450a7e.png)
...
[一步一图带你深入理解 Linux 物理内存管理_预留内存linux-CSDN博客](https://blog.csdn.net/weixin_47282449/article/details/127980437)